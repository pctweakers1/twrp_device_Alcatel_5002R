...
DEVICE_PATH := device/tcl/Seoul_ATT
...
# Assert
TARGET_OTA_ASSERT_DEVICE := Seoul_ATT

# Bootloader
TARGET_BOOTLOADER_BOARD_NAME := RGZDP1P0CT00
...
TARGET_KERNEL_SOURCE := kernel/tcl/Seoul_ATT
TARGET_KERNEL_CONFIG := Seoul_ATT_defconfig
